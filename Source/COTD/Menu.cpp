...
void Menu::FadeOut()
{
	const uint16_t toggleMask = 0x1f6e;
	const int fizzlesPerFrame = 255;
	const uint16_t startValue = 1;
	...
	for (int n = 0; n < fizzlesPerFrame; n++)
	{
		...
		{
			Game::SwitchState(Game::GS_GameOver);
			return;
		}
	}
